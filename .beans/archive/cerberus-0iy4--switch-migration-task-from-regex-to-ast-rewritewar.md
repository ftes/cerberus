...
Replace regex-based rewrites and unsupported-pattern detection in mix cerberus.migrate_phoenix_test with AST traversal while preserving existing migration behavior and warnings.

## Summary of Changes

- Replaced regex-based rewrite and warning detection in lib/mix/tasks/cerberus.migrate_phoenix_test.ex with an AST traversal engine using Code.string_to_quoted and Macro.prewalk.
