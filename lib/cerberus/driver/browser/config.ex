defmodule Cerberus.Driver.Browser.Config do
  ...
  @spec ensure_popup_mode_supported!(Types.browser_name(), :allow | :same_tab) :: :ok
  def ensure_popup_mode_supported!(browser_name, _popup_mode) when browser_name in [:chrome, :firefox], do: :ok
