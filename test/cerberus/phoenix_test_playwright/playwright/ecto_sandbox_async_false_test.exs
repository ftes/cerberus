defmodule Cerberus.PhoenixTestPlaywright.Playwright.EctoSandboxAsyncFalseTest do
  ...
  for delay_ms <- [0, 100] do
    ...
    describe "delay: #{delay_ms}ms requires ecto_sandbox_stop_owner_delay to prevent owner errors" do
