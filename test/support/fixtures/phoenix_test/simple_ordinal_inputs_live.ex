defmodule Cerberus.Fixtures.PhoenixTest.SimpleMailingList do
  @moduledoc false
  use Ecto.Schema
...
defmodule Cerberus.Fixtures.PhoenixTest.SimpleOrdinalInputsLive do
  @moduledoc false
  use Phoenix.LiveView
  use Phoenix.Component

  import Cerberus.Fixtures.PhoenixTest.Components

  alias Cerberus.Fixtures.PhoenixTest.SimpleMailingList
