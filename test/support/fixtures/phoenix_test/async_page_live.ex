defmodule Cerberus.Fixtures.PhoenixTest.AsyncPageLive do
  @moduledoc false
  ...
  def handle_async(:async_navigate_to_async, {:ok, _result}, socket) do
    {:noreply, push_navigate(socket, to: "/phoenix_test/live/async_page_2")}
  end

  def handle_async(:async_redirect, {:ok, _result}, socket) do
    Process.sleep(100)
    {:noreply, redirect(socket, to: "/phoenix_test/page/index")}
  end
