defmodule Cerberus.Fixtures.PhoenixTest.PageView do
  ...
  def render("index.html", assigns) do
    ...
    <a href="/phoenix_test/page/page_2?foo=bar">Page 2</a>

    <a href="/phoenix_test/page/no_page?redirect_to=/phoenix_test/page/index">Navigate away and redirect back</a>

    <a class="multiple_links" href="/phoenix_test/page/page_3">Multiple links</a>
    <a class="multiple_links" href="/phoenix_test/page/page_4">Multiple links</a>

    <a href="/phoenix_test/live/index">To LiveView!</a>
    ...
    <a
      href="/phoenix_test/page/delete_record"
      data-method="delete"
      data-to="/phoenix_test/page/delete_record"
      data-csrf="sometoken"
    >
      Data-method Delete
    </a>
    ...
    <button data-method="delete" data-to="/phoenix_test/page/delete_record" data-csrf="sometoken">
      Data-method Delete
    </button>

    <form action="/phoenix_test/page/get_record">
      <button>Get record</button>
    </form>

    <form action="/phoenix_test/page/update_record" method="post">
      <input name="_method" type="hidden" value="put" />
      <button>Mark as active</button>
    </form>

    <form action="/phoenix_test/page/delete_record" method="post">
      <input name="_method" type="hidden" value="delete" />
      <button>Delete record</button>
    </form>

    <form action="/phoenix_test/page/create_record" method="post" id="email-form">
      <label for="email">Email</label>
      <input type="text" id="email" name="email" />
      <button type="submit">Save Email</button>
    </form>

    <form id="update-form" action="/phoenix_test/page/update_record" method="post">
      <input name="_method" type="hidden" value="put" />
      <label for="update-form-name">Name</label>
      <input id="update-form-name" name="name" />
      <button type="submit" hidden>Submit update form</button>
    </form>

    <form action="/phoenix_test/page/create_record" method="post" id="no-submit-button-form">
      <label for="no-submit-button-form-name">Name</label>
      <input id="no-submit-button-form-name" name="name" />
      <button type="submit" hidden>Submit no-submit-button form</button>
    </form>

    <form action="/phoenix_test/page/create_record" method="post" id="pre-rendered-data-form">
      <label>
      ...
      <button type="submit" hidden>Submit pre-rendered-data form</button>
    </form>

    <form id="nested-form" method="post" action="/phoenix_test/page/create_record">
    ...
    <form id="full-form" method="post" action="/phoenix_test/page/create_record">
    ...
    <form
      id="file-upload-form"
      method="post"
      action="/phoenix_test/page/create_record"
    ...
    <form id="redirect-to-liveview-form" method="post" action="/phoenix_test/page/redirect_to_liveview">
      <label for="name">Name</label>
      <input name="name" />
      <button type="submit">Save and Redirect to LiveView</button>
    </form>

    <form method="post" action="/phoenix_test/page/redirect_to_liveview">
      <button>Post and Redirect</button>
    </form>

    <form id="no-submit-button-and-redirect" method="post" action="/phoenix_test/page/redirect_to_liveview">
      <label for="no-submit-and-redirect-name">Name</label>
      <input id="no-submit-and-redirect-name" name="name" />
      <button type="submit" hidden>Submit no-submit-button and redirect form</button>
    </form>

    <form id="no-button-form" method="post" action="/phoenix_test/page/create_record">
      <label for="no-button-form-country">Country of Origin</label>
      <input type="text" id="no-button-form-country" name="country" />
      <button type="submit" hidden>Submit no-button form</button>
    </form>
    ...
    <form action="/phoenix_test/page/create_record" method="post" id="owner-form">
    ...
    <form id="complex-labels" method="post" action="/phoenix_test/page/create_record">
    ...
    <form id="same-labels" action="/phoenix_test/page/create_record" method="post">
      <fieldset>
  ...
  def render("delete_record.html", assigns) do
    ~H"""
    <h1>Record deleted</h1>
    """
  end
