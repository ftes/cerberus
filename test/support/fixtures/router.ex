defmodule Cerberus.Fixtures.Router do
  ...
  scope "/", Cerberus.Fixtures do
    ...
    get("/browser/readiness/busy-live-root-inflight", PageController, :busy_live_root_inflight)
    get("/browser/actionability/long-budget", PageController, :long_action_budget)
    get("/browser/action-settle/deferred-submit", PageController, :deferred_submit_form)
    get("/browser/action-settle/same-path-submit", PageController, :same_path_submit)
    post("/browser/action-settle/same-path-submit", PageController, :same_path_submit)
    ...
    get("/owner-form/live-redirect", PageController, :owner_form_live_redirect)
    get("/owner-form/slow-redirect", PageController, :owner_form_slow_redirect)
