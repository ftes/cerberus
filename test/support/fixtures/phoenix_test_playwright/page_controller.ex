defmodule Cerberus.Fixtures.PhoenixTestPlaywright.PageController do
  use Phoenix.Controller, formats: [html: "View"]

  plug(:put_layout, html: {Cerberus.Fixtures.PhoenixTestPlaywright.LayoutView, :app})
  ...
  def redirect_to_liveview(conn, _) do
    ...
    |> redirect(to: "/phoenix_test/playwright/live/index")
  end
