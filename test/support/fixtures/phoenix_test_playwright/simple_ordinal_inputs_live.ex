defmodule Cerberus.Fixtures.PhoenixTestPlaywright.SimpleMailingList do
  @moduledoc false
  use Ecto.Schema
...
defmodule Cerberus.Fixtures.PhoenixTestPlaywright.SimpleOrdinalInputsLive do
  @moduledoc false
  use Phoenix.LiveView
  use Phoenix.Component

  import Cerberus.Fixtures.PhoenixTestPlaywright.Components

  alias Cerberus.Fixtures.PhoenixTestPlaywright.SimpleMailingList
