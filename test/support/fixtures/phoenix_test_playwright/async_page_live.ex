defmodule Cerberus.Fixtures.PhoenixTestPlaywright.AsyncPageLive do
  @moduledoc false
  ...
  def handle_async(:async_navigate_to_async, {:ok, _result}, socket) do
    {:noreply, push_navigate(socket, to: "/phoenix_test/playwright/live/async_page_2")}
  end

  def handle_async(:async_redirect, {:ok, _result}, socket) do
    Process.sleep(100)
    {:noreply, redirect(socket, to: "/phoenix_test/playwright/page/index")}
  end
