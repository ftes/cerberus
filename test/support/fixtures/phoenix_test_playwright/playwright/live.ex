defmodule Cerberus.Fixtures.PhoenixTestPlaywright.Playwright.Live do
  @moduledoc false
  ...
  def render(assigns) do
    ~H"""
    <h1>Playwright</h1>
    <a href="/phoenix_test/playwright/pw/other">Navigate</a>
    <a data-confirm="Are you sure?" href="/phoenix_test/playwright/pw/other">Confirm to navigate</a>
